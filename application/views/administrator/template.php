    ...
    <div class="wrapper">
      ...
      <div class="content-wrapper">
        ...
        <div class='alert alert-warning alert-dismissible fade in' role='alert' style='border-radius:0px; margin-bottom:0px'>
          ...
          <a href="http://www.mycoding.net/" style="margin-right:10px; text-decoration:none;">Selamat datang di halaman administrator, Saat ini anda menggunakan CMS pengembangan dari </a>
          <a target='_BLANK' class="btn btn-default btn-sm" href="http://www.mycoding.net/" style="color: rgb(243, 156, 18);">Swarakalibata CodeIgniter</a>
        </div>
      <?php } ?>

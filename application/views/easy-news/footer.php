					...
					<div class="widget">
						...
						<div class="about--widget">
								<div class="header--logo float--left float--sm-none text-sm-center" style="width:90%;">
									...
									?>
									<span class="hidden">SimpleNews</span></h1>
								</div>
							<div class="action">
								<a href="<?php echo base_url(); ?>hubungi" class="btn-link"> Hubungi kami<i class="fa flm fa-angle-double-right"></i></a>
							</div>
							<ul class="nav">
								<?php
	...
	<div class="footer--copyright bg--color-3">
		...
		<div class="container">
			<p class="text float--left">
				&copy; 2017 <a href="http://mycoding.net">SIMPLE NEWS</a>. All Rights Reserved.
			</p>
